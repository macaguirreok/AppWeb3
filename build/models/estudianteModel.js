...
__decorate([
    (0, typeorm_1.PrimaryGeneratedColumn)() //decorador. Funcion especial para definir
    ,
...
__decorate([
    (0, typeorm_1.Column)() //marca que el campo nombre se almacenará como columna
    ,
    __metadata("design:type", String)
...
exports.Estudiante = Estudiante = __decorate([
    (0, typeorm_1.Entity)('estudiantes') //entidad mapeada a la tabla estudiantes
], Estudiante);
